...
//A HE_WCHAR if UNICODE is defined, a HE_CHAR otherwise.
//typedef char  HE_TCHAR 
 
//A HE_LPWSTR if UNICODE is defined, a HE_LPSTR otherwise. 
//typedef char *  HE_LPTSTR 

//A HE_LPCWSTR if UNICODE is defined, a HE_LPCSTR otherwise.
//typedef char const *  HE_LPCTSTR 
 
//A value used to denote the position of an element in a collection.
//typedef void *  HE_POSITION 

...
{
public :
	CHE_GraphicsObject( HE_BYTE type = GRAPHTYPE_INVALID, CHE_Allocator * pAllocator = NULL ) : CHE_Object( pAllocator ) { m_type = type; }
...
{
public:
	CHE_Line( HE_FLOAT StartX, HE_FLOAT StartY, HE_FLOAT EndX, HE_FLOAT EndY, CHE_Allocator * pAllocator = NULL ) 
		: CHE_GraphicsObject( GRAPHTYPE_LINE, pAllocator )
...
public:
	CHE_BCurve( HE_FLOAT X1, HE_FLOAT Y1, HE_FLOAT X2, HE_FLOAT Y2, HE_FLOAT X3, HE_FLOAT Y3,
				HE_FLOAT X4, HE_FLOAT Y4, CHE_Allocator * pAllocator = NULL )
		: CHE_GraphicsObject( GRAPHTYPE_BCURVE, pAllocator )
...
{
public:
	CHE_Rectangle( HE_FLOAT leftTopX, HE_FLOAT leftTopY, HE_FLOAT width, HE_FLOAT height, CHE_Allocator * pAllocator = NULL ) : CHE_GraphicsObject( GRAPHTYPE_RECTANGLE, pAllocator )
...
{
public:
	CHE_Path( CHE_Allocator * pAllocator = NULL ) : CHE_GraphicsObject( GRAPHTYPE_PATH, pAllocator ), m_objArray( pAllocator ) {}

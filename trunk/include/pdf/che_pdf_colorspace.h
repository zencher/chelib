...
enum PDF_COLORSPACE_TYPE
{
	...
	COLORSAPCE_CIEBASE_CALGRAY		= 0x04,
	COLORSAPCE_CIEBASE_CALRGB		= 0x05,
	COLORSAPCE_CIEBASE_CALCMYK		= 0x06,
	COLORSAPCE_CIEBASE_CALLAB		= 0x07,
	COLORSAPCE_CIEBASE_ICCBASED		= 0x08,
	COLORSAPCE_SPECIAL_PATTERN		= 0x09,
	COLORSAPCE_SPECIAL_INDEXED		= 0x0A,
	COLORSAPCE_SPECIAL_SEPARATION	= 0x0B,
	COLORSAPCE_SPECIAL_DEVICEN		= 0x0C
};

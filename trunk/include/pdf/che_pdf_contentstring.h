...
public:
	...
	*	@brief 输出文本图形状态指令
	*/
	static HE_BOOL TextStateToBuf(	const CHE_PDF_GState * pTextState, CHE_DynBuffer & buf, HE_BOOL bNewBlock = FALSE );
	...
	*/
	static HE_BOOL TextStateToBuf(	const CHE_PDF_GState * pCurGSData, const CHE_PDF_GState * pTargetGSData, CHE_DynBuffer & buf, HE_BOOL bNewBlock = FALSE );

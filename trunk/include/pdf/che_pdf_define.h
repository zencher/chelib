...
enum PDF_INOBJ_TYPE
{
	INOBJ_TYPE_COMMON		= 0x00,
	INOBJ_TYPE_COMPRESSED	= 0x01
};
...
{
	FONT_ENCODING_WINANSIENCODING	= 0x00,
	FONT_ENCODING_MACROMANENCODING	= 0x01,
	FONT_ENCODING_MACEXPERTENCODING	= 0x02
};

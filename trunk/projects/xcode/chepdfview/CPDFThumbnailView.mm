...
@implementation CPDFThumbnailMainView
...
@implementation CPDFThumbnailScrollView
        ...
        parentView:(id)parent
{
    ...
    if (self) {
        mainView = [[CPDFThumbnailMainView alloc] initWithFrame:frameRect parentView:self];
...
@implementation CPDFThumbnailView

-(id)initWithFrame:(NSRect)frameRect
{
    self = [super initWithFrame:frameRect];
    if (self) {
        scrollView = [[CPDFThumbnailScrollView alloc] initWithFrame:frameRect parentView:self];

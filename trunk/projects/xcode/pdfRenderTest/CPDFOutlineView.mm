...
@implementation CPDFOutlineScrollView
...
@implementation CPDFOutlineView

-(id)initWithFrame:(NSRect)frameRect
{
    self = [super initWithFrame:frameRect];
    if (self) {
        scrollView = [[CPDFOutlineScrollView alloc] initWithFrameAndParentView:frameRect parentView:self];

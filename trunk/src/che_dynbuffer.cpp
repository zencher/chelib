...
//HE_DWORD CHE_DynBuffer::SetData( HE_DWORD offset, const HE_LPBYTE pBuffer, HE_DWORD size );

//HE_DWORD CHE_DynBuffer::GetData( HE_DWORD offset, HE_LPBYTE pBuffer, HE_DWORD size );

...
// 		return NULL;
// 	}
// 	HE_PDF_RefInfo objRefInfo = m_pParser->GetPageObjNum( iPageIndex );
// 	if ( objRefInfo.objNum == 0 )
// 	{
// 		return NULL;
// 	}
// 	CHE_PDF_Object * pPageObj =  m_pParser->GetObject( objRefInfo );
...
// 				return NULL;
// 			}else{
// 				objRefInfo.objNum = pObj->ToReference()->GetRefNum();
// 				objRefInfo.genNum = pObj->ToReference()->GetGenNum();
// 				pObj = m_pParser->GetObject( objRefInfo );
...
// }
// 
// CHE_PDF_Stream * CHE_PDF_Page::GetPageContent()
// {
// 	CHE_PDF_Stream * pStreamRet = NULL;
// 	CHE_PDF_Dictionary * pPageDict = m_pPageObj;
// 	if ( pPageDict == NULL )
// 	{
// 		return NULL;
